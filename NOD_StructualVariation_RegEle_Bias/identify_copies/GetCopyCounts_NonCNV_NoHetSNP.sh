...
peakList=/Scottbrowne/members/smd/Projects/SD032/CopyBiasCounts/peakIDs_NonCNV_NoHetSNP.txt
ArchRExt=150
...
outPathBase=/Scottbrowne/seq/tmp/devoes/SD032/CopyBiasCounts_NonCNV_NoHetSNP
...
: > $outCopies # initialize empty out file
...
sort -k1,1 -k2,2n $outCopies > ${outCopies/".tsv"/".bed"}
