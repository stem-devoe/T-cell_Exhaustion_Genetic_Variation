...
# set paths 
bamPaths=/Scottbrowne/members/smd/Projects/SD029/sample_lists/bam-paths_tn5-shift_2bed.txt
outdir=/scratch2/devoes/SD029/macs2_bed/bed
...
bamBase=$(basename $bam .bam) # NOD files are .sorted_shifted_from_NOD_SHILTJ.bam, B6 files are .sorted.bam
bamBase=${bamBase/'.sorted'/}
bamBase=${bamBase/'_shifted'/'.shifted'}
echo $bamBase
