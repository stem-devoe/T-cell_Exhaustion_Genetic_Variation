...
motif_db = "HOCOMOCO" # homer vierstra_v2.1beta HOCOMOCO Cistarget
phenotype = "CART" # CART LCMV Naive
rm_peak = read.delim("/scratch2/devoes/SD029/ConsensusPeaks_intersect_AnyHetSNP.bed",
                     header = F)
...
pdf(paste0("/Scottbrowne/members/smd/Projects/SD029/motif_disruption/",
           ...
           "/",
           Sys.Date(),
           "_NoHetSNP_2sample_MotifDisruption_volcano.pdf"))
p.volcano
dev.off()
...
pdf(file = paste0("/Scottbrowne/members/smd/Projects/SD029/motif_disruption/",
                  ...
                  "/",
                  Sys.Date(),
                  "_NoHetSNP_2sample_MotifDisruptions_LFC_waterfall.pdf"))
p.waterfall
dev.off()
...
pdf(file = paste0("/Scottbrowne/members/smd/Projects/SD029/motif_disruption/",
                  ...
                  "/",
                  Sys.Date(),
                  "_NoHetSNP_2sample_MotifDisruptions_LFC_scatter.pdf"))
p.scatter
dev.off()
