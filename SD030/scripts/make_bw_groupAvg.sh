set -eux
binSize=10
samples=/Scottbrowne/members/smd/Projects/SD030/sample_inputs/low-noise_archr-iterative-merge_input.tsv
blacklist=/Scottbrowne/members/smd/genomes/mm10/blacklist/mm10-blacklist-v2_chrUnRandomBlacklist.bed

bigwig_path=/Scottbrowne/seq/tmp/devoes/SD030/bigwig_binSize${binSize}/bigwig_cpm_recip-frip/ # make sure ends in "/"
bigwig_ext="_cpm_recip-frip.bw"

outdir=/Scottbrowne/seq/tmp/devoes/SD030/bigwig_binSize${binSize}/bigwig_cpm_recip-frip_groupAvg
